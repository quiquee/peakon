...
- (void)beaconScanner:(ESSBeaconScanner *)scanner
           didFindURL:(NSURL *)url  peripheralData:(NSString*)peripheralData  peripheralIdentifier:(NSString*)peripheralIdentifier  advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI;
